...
Bacanora uses Agave angustifolia, which in mezcal DO, its maguey is called Espadin. In Sonora, where Bacanora is produced, two maguey types of Agave angustifolia are used: [Pacifica](https://www.mezcalreviews.com/filter-by/maguey/pacifica/) and [Yaquiana](https://www.mezcalreviews.com/filter-by/maguey/yaquiana/)
