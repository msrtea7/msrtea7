...
import im1 from '../../assets/bar/im1.png'
import im2 from '../../assets/bar/im1.png'

<h5 align="center">Fig.1 Example of flavor group how they organize recipe data</h5>
<div style="text-align: center;">
    <Image src={im1} alt="Gin tasting" class="single_img" />
</div>
<br />

<h5 align="center">Fig.2 The related self-made ingredients</h5>
<div style="text-align: center;">
    <Image src={im2} alt="Gin tasting" class="single_img" />
</div>
<br />