...
| BSC Perspective | Bar Premises - During Business Hours | Bar Premises - After Business Hours | Non-Bar Premises |
|---------|-------------------|-------------------|-----------|
| **Financial Perspective** || • <span className="kitchen">Back of House: IoT device energy and waste monitoring</span> |• Blockchain technology enhancing supply chain transparency<br/> |
